...
> 本仓库按分阶段路线图开发,完整设计见计划文档。**当前已完成 Phase 1(引导式讲解核心)与 Phase 2(动态可拖动几何)。**
...
覆盖:SM-2 调度、几何测量(距离/面积/角度/格式化)、结构化输出 schema 校验、**SVG 安全消毒(恶意输入清除 / 正常几何保留)**、API 客户端成功与各错误码处理。

## 路线图(后续阶段)

Phase 3 真实生活图片(Imagen/gpt-image,插画风) · Phase 4 家长账号+孩子档案+合规(未成年人模式/防沉迷) · Phase 5 家长面板(掌握度/薄弱点/有效时长/花费) · Phase 6 预制视频库。
